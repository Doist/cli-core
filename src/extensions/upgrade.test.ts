...
import { writeFixtureExtension } from '../testing/extensions.js'
...
// `restoreMocks` puts a spy's implementation back but leaves the call history
// of a module-mock `vi.fn` alone, and the dependency assertions below read
// that history.
beforeEach(() => {
