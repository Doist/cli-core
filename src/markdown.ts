...
export { darkTheme, lightTheme } from 'marked-terminal-renderer'
 ...
 * markdown (e.g. `--json` / `--ndjson` runs) don't pay the load cost.
 *
 * ```ts
 * import { preloadMarkdown, renderMarkdown } from '@doist/cli-core'
 *
 ...
 *
 * ```ts
 * import { lightTheme, preloadMarkdown } from '@doist/cli-core'
